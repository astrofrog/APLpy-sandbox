...
# There were reasons why I had to overload the colorbar in APLpy, so we should
# check if that is still an issue.
...
# which can also take a 'system' keyword argument. The latter two can also be
# plotted by making a patch and adding it the normal way:

from aplpy.patches import Beam, Compass
